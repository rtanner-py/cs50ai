...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        #3 add new sentence to KB based on cell and count
        ...
        for i in range(cell[0]-1, cell[0]+2):
            for j in range(cell[1]-1, cell[1]+2):
                if 0 <= i < self.height and 0 <= j < self.width: #checks valid cell
                    if (i,j) == cell:
        ...
        #5 Add any new inferred sentences
        ...
        for subset in self.knowledge:
            for superset in self.knowledge:
                ...
                if subset.cells.issubset(superset.cells):
                    result_cells = superset.cells - subset.cells
                    result_mines = superset.count - subset.count
                    s = Sentence(result_cells, result_mines)
